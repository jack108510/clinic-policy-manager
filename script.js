...
function checkAdminPassword(event) {
    ...
    // Check if this is the demo user - bypass password for demo
    if (currentCompany === 'Demo Company' && currentUser.username === 'demo') {
        console.log('✅ Demo user detected, granting access without password');
        closePasswordModal();
        openAdminModal();
        showNotification('Admin access granted!', 'success');
        return;
