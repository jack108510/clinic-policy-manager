        ...
        resultCard.innerHTML = `
            ...
            <div class="policy-preview professional" style="max-width: 100%;">
                <div class="policy-header" style="margin-bottom: 20px; padding-bottom: 15px; border-bottom: 2px solid #e5e7eb;">
                    ...
                    <span class="policy-type-badge ${typeClass}" style="display: inline-block; padding: 6px 12px; background: ${typeClass === 'admin' ? '#e3f2fd' : typeClass === 'sog' ? '#fff3e0' : typeClass === 'protocol' ? '#d1fae5' : typeClass === 'memo' ? '#f3e5f5' : typeClass === 'training' ? '#fce7f3' : typeClass === 'reference' ? '#ccfbf1' : typeClass === 'governance' ? '#e0e7ff' : '#f3e5f5'}; color: ${typeClass === 'admin' ? '#1976d2' : typeClass === 'sog' ? '#f57c00' : typeClass === 'protocol' ? '#059669' : typeClass === 'memo' ? '#7b1fa2' : typeClass === 'training' ? '#be185d' : typeClass === 'reference' ? '#0d9488' : typeClass === 'governance' ? '#4f46e5' : '#7b1fa2'}; border-radius: 20px; font-size: 12px; font-weight: 600;">
                        ${typeLabel}
                    </span>
                </div>
